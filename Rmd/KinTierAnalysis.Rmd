...
cp_trans_data <- trans_data %>%
  ...
  mutate(
    trans_cat = case_when(
      mapply(identical,facility_from,facility_to) & method_into_art =="1" ~ "transfer in",
...
cp_vis_cohort_u_data <-data.frame(matrix(ncol = 26,nrow = 0))
